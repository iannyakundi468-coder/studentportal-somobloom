...
export default function SomoBloomLogo({ size = 32, showText = true, fontSize = '16px' }: LogoProps) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', userSelect: 'none' }}>
      ...
      {showText && (
        <span style={{ fontSize: fontSize, fontWeight: '800', letterSpacing: '-0.02em', color: 'inherit' }}>
