/**
 * SomoBloom API Client
 * Handles requests to the backend with proper authentication and error handling.
 */
  ...
  constructor() {
    ...
    if (typeof window !== 'undefined') {
      window.addEventListener('online', () => {
        console.log('[Offline Sync] Student Portal restored online. Replaying operations...');
